...
procedure PlayList is
    ...
    type pieceOrPause is (PIECE, PAUSE);        --This is an enum basically

    type Item(item_variant : pieceOrPause) is record

    length_secs :float;             --Left outside because it's the same for both
    ...
    begin
      case i.item_variant is            --Using the variant of the passed object
         when PIECE =>
